...
export default function LoginScreen() {
  ...
  if (state.authStatus === 'pendingApproval') {
    return (
      <div className="app-shell" style={{ justifyContent: 'center', padding: '32px 26px', background: 'var(--login-bg)', color: 'var(--ink-soft)', textAlign: 'center' }}>
  ...
  return (
    <div className="app-shell" style={{ justifyContent: 'center', padding: '32px 26px', background: 'var(--login-bg)', color: 'var(--ink-soft)' }}>
