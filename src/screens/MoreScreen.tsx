...
export default function MoreScreen() {
  ...
  const items = [
    ...
    ...(state.role !== 'tech' ? [{ label: 'จัดการรายการยา', sub: 'ชื่อ ขนาด หน่วย ราคา par ชั้นวาง — แก้ทุกอย่างของยาแต่ละตัวได้ที่นี่', go: () => go('meds') }] : []),
    { label: 'par อัตโนมัติ & เกณฑ์แจ้งเตือน', sub: 'คำนวณ par แนะนำจากสถิติการใช้ · ตั้งวันแจ้งเตือนหมดอายุ', go: () => go('settings') },
    { label: 'ย้ายยาระหว่างชั้นวาง', sub: 'เช่น แบ่งยาฉีดจากลิ้นชักล็อก IPD มาวาง stat OPD', go: () => go('wardmove') },
    { label: 'บัตรสต็อก substock', sub: 'รับ-จ่าย-คงเหลือ real-time แทนบัตรกระดาษ', go: () => go('substockcard') },
